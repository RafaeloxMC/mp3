/*
Font glyph bitmap data derived from the Adafruit-GFX-Library glcdfont table.
Adafruit-GFX-Library is licensed under the BSD license.
...
#define FONT5X7_GLYPH_HEIGHT 8

static const unsigned char font5x7_table[] = {
